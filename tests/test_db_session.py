...
def test_database_settings_default_sqlite_url_does_not_require_hermes(monkeypatch, tmp_path):
...
def test_database_settings_database_url_override():
    ...
    settings = DatabaseSettings.from_env({'DATABASE_URL': 'postgresql+psycopg://db/app'})
